...
Route::middleware('IsLogin')->group(function() {
    ...
    Route::prefix('/order')->name('admin.order.')->group(function(){
        ...
        Route::get('/admin/order', [OrderController::class, 'cari'])->name('cari');
    ...
    Route::middleware('IsKasir')->group(function(){
        Route::prefix('order')->name('kasir.order.')->group(function(){
            ...
            Route::get('/order/{id}', [OrderController::class, ]);
            Route::get('/kasir/order', [OrderController::class, 'search'])->name('search');
        });
    });
});
