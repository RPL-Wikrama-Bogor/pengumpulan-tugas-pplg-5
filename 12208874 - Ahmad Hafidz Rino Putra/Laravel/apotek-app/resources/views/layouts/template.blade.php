...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand" href="#">Apotek SukaBapak</a>
                ...
                <ul class="navbar-nav">
                    ...
                    @if (Auth::check())
                        @if (Auth::user()->role == 'admin')
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{ route('user.data') }}">Kelola Akun</a>
                            </li>
                            <li class="nav-item dropdown">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{ route('admin.order.data') }}">Pembelian</a>
                            </li>
                        @else
                            <li class="nav-item">
