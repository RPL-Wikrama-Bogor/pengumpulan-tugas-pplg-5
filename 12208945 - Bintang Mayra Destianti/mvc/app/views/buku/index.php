...
<div class="container">
    ...
    <div>
    <a href="<?= BASE_URL;?>/buku/tambah" class="btn text-white" style="background-color: #12486B;"></i>Tambah Peminjaman</a>
    </div>
    <div class="d-flex">
    ...
    <a href="<?= BASE_URL;?>/buku/index" class="btn btn-secondary" style="background-color: white ; color: red; border: solid 1px red;"><i class="fa-solid fa-rotate"></i></a>
    </div>
    </div>
    <br>
    <br>
                ...
                <tr>
                  ...
                  <td> 
                    <?php
                        ...
                        // else ( $selisih_hari ==1 && $selisih_

                        // )
                    ?>
                        <a href="<?= BASE_URL ?>/buku/deleteBuku/<?= $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Hapus data?');">hapus</a>
                  </td>
                </tr>
                <?php $no++; endforeach; ?>
        </tbody>
