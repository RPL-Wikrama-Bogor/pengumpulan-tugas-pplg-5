...
<body>
    <div id="back-wrap">
        <button type="submit" class="kembali"><a href="{{ route('kasir.order.index') }}" class="btn-black">Kembali</a></button>
       
    </div>
    <div id="receipt">
        <a href="{{ route('kasir.order.download', $order['id']) }}" class="btn-print" style="text-decoration: none">Cetak (.pdf)</a>
        <center id="top">
            <div class="info">
