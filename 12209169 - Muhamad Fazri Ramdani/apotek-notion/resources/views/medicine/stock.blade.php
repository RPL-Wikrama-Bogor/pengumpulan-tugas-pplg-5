...
<div class="modal fade" id="tambah-stock" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    @push('script')
        ...
        $(function(){
            //kalau di sission js nya ada property reloadAfterPageLoad
            if (sessionStorage.reloadAfterPageLoad){
                //tambah class alert di id="msg_success
                $('msg-success').attr("class","alert alert-success");
                //isi teks di alertnya
                $('#msg-success').text("Berhasil menambahkan data stock!");
                //hapus session js tersebut agar alert hanya muncul setelah reload update data aja, reload selain itu gak di munculkan 
