    ...
    <form action="<?= BASE_URL; ?>/pinjam/updatePinjam" method="post">
        <div class="class-body">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" name="nama_peminjam" id="nama_peminjam" value="<?= $data['pinjam']['nama_peminjam']; ?>" >
            </div>
            <div class="form-group mb-3">
                <label for="jenis_barang">Jenis Barang</label>
                <input type="text" class="form-control" name="jenis_barang" id="jenis_barang" placeholder="HP, LAPTOP, LAN ADAPTOR" value="<?= $data['pinjam']['jenis_barang']; ?>" required readonly>
            </div>
            <div class="form-group mb-3">
                <label for="no_barang">Nomor Barang</label>
                <input type="number" class="form-control" name="no_barang" id="no_barang" value="<?= $data['pinjam']['no_barang']; ?>" >
            </div>
            <div class="form-group mb-3">
