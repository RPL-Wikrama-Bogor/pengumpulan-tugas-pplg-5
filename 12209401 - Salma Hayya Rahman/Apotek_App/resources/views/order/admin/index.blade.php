            ...
            <div class="col-md-6 mt-5">
                <form action="{{ route('admin.order.data') }}" method="GET">
                    <div class="input-group mb-3">
                        ...
                        <a href="{{ route('admin.order.search') }}" style="margin-left:5px;"><button class="btn btn-secondary" type="button" >clear</button></a>
                    </div>
                </form>
            </div>
            <div class="col-md-6">
            ...
            <tbody>
                ...
                @foreach ($orders as $item)
                    <tr>
                        ...
                        <td><a href="{{ route('admin.order.download', $item['id']) }}" class="btn btn-secondary">Unduh(.pdf)</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
