...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand" href="/dashboard">Apotek App</a>
    ...
    <div class="container">
        {{-- bagian dinamis yg akan berubah tiap pagenya, harus diisi di file yang extends ke template ini --}}
        @yield('content')
    </div>
    ...
    {{-- bagian optional , boleh diisi atau engga, buat penyimpanan script tambahan dari page yang dipanggil --}}
    @stack('script')
</body>
