    ...
    <form action="<?= BASE_URL; ?>/buku/simpanbuku" method="post">
        ...
        <?php
            ...
            <div class="form-group mb-3">
                ...
                <input type="varchar" class="form-control" id="nama_peminjam" name="nama_peminjam" value="<?= isset($_POST['nama_peminjaman']) ? $_POST['nama_peminjaman'] : '' ?>">
            </div>
            <div class="form-group mb-3">
            ...
            <input type="datetime-local" class="form-control" id="tanggal_pinjam" name="tanggal_pinjam" value="<?= isset($_POST['tanggal_pinjam']) ? $_POST['tanggal_pinjam'] : '' ?>">
            </div>
        </div>
