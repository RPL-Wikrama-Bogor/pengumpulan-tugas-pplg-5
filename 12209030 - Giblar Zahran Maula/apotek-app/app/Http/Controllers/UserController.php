...
class UserController extends Controller
{
    public function loginAuth(Request $request)
    {
        ...
        //ambil value dari input dan simpan di sebuat variable
        $user = $request->only(['email', 'password']);
        //Auth::attempt -> memasukan data user yang di input ke fitur auth laravel(komfirmasi proses autentikasi)
        if (Auth::attempt($user)) {
            //kalau akun sesuai antara email dan pass nya, dan proses pemyimpanan data ke auth nya berhasil jalanin
