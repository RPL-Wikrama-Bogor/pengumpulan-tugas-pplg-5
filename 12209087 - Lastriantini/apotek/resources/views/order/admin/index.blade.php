...
{{-- bootstrap 4 pake left right (rt) kalo 5 pake end start --}}
    ...
    <form class="form d-inline" action="{{ route('admin.order.data') }}" method="GET">
            ...
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td>{{ $order['user']['name'] }}
                        ...
                        <td><a href="{{ route('admin.order.unduh-pdf', $order['id']) }}" class="btn btn-secondary">Unduh (.pdf)</a></td>
                    </td>
                </tr>
            @endforeach
        </tbody>
