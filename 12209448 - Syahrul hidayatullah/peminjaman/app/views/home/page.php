                ...
                <div class="modal-body">
                    <form action="<?=BASE_URL?>/home/tambah" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" hidden class="form-control" id="namaPeminjam" placeholder="Nama Peminjam" name="status" value="Belum">
                        </div> <br><br>
                        <div class="form-group">
...
<table class="table table-bordered table-striped table-light">
    ...
    <?php foreach( $data['pinjam'] as $row): ?>
        <?php if ($row['status'] == 'sudah'):?>
            ...
            <td>
               <a href="<?=BASE_URL?>/home/hapus/<?=$row['id']?>" onclick="return confirm('Yang benerrr?')"><button class="btn btn-danger action-button" >Hapus</button></a> 
            </td>
            <?php else: ?>
