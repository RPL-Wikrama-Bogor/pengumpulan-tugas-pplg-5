    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            {{--input type hidden, digunakan untuk data yg nantinya berguna namun tidak ingin diperlihatkan ke user--}}
    ...
    <script>
        ...
        $("#tambah-stock").submit(function (e) {
            ...
            $.ajax({
                ...
                cache: false, //tidak mengirim data lain lain yang menempel di data yang ingin di kirim
                //kalau berhasil
                success: function (res) {
