...
<body>
    <div id="receipt">
        <center id="top">
            <div class="info">
                <h2>Apotek Bla Bla</h2>
            </div>
        </center>
        <div class="mid">
            <div class="info">
                <p>
                    Alamat : KP.Pasir Muncang Rt.04/01, Megamendung, Sukamanah, Kabupaten Bogor, Jawa Barat<br>
                    Email :ardilarosliani12@gmail.com<br>
                    Phone : 0812-5712-1757<br>
                </p>
            </div>
        </div>
        <div class="bot">
